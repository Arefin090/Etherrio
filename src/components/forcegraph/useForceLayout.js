...
function useForceLayout({ strength = -1500, distance = 250 }) { // Adjusted strength and distance
    ...
    useEffect(() => {
        ...
        const simulation = forceSimulation()
            ...
            .force('link', forceLink(simulationLinks)
                ...
                .strength(0.05)
                .distance(distance))
            .force('x', forceX().x(0).strength(0.1)) // Adjusted strength
            .force('y', forceY().y(0).strength(0.1)) // Adjusted strength
            .on('tick', () => {
